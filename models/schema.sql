CREATE TABLE IF NOT EXISTS 'users'(
    ...
    'name' TEXT NOT NULL
    'activated' TEXT NOT NULL CHECK(activated==1 or activated==0) DEFAULT 1
...
CREATE TABLE IF NOT EXISTS 'accounts'(
    ...
    'activated' INTEGER NOT NULL (activated==1 or activated==0) DEFAULT 1,
    'created_at' NUMERIC NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX 'user_index' IF NOT EXISTS ON 'users'('name');
CREATE INDEX 'bank_index' IF NOT EXISTS ON 'banks'('name');
CREATE INDEX 'accounts_index' IF NOT EXISTS ON 'accounts'('bank_id,user_id');
